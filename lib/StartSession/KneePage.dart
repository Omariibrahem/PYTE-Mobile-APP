...
class KneePage extends StatefulWidget {
  @override
  _KneePageState createState() => _KneePageState();
}

class _KneePageState extends State<KneePage> {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            DropdownButton<String>(
              ...
              items: <String>['Flexion', 'Extension'].map((String value) {
