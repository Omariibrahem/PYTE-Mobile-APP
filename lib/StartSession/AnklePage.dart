...
class AnklePage extends StatefulWidget {
  @override
  _AnklePageState createState() => _AnklePageState();
}

class _AnklePageState extends State<AnklePage> {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            DropdownButton<String>(
              ...
              items: <String>['Dorsiflexion', 'Plantarflexion', 'Eversion', 'Inversion']
                  .map((String value) {
            ...
            DropdownButton<String>(
              value: intensity,
              items: <String>['Light', 'Moderate', 'Strong']
                  .map((String value) {
                return DropdownMenuItem<String>(
                  value: value,
                  child: Text(value),
